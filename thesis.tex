...
%
\documentclass[MSc,beforeDefense,fullpageDraft]{misc/iitthesis}
...
% Antonio: Added my theorem styling here
\include{misc/my-theorem-styling}
...
\include{main/mainchap2}
\include{main/mainchap3}
\include{main/mainchap4}
\include{main/mainchap5}
\include{main/mainchap6}
...
% Antonio: If the lemma in the Appendix has numbering 1.1 then use the following code to turn it into A.1
% \makeatletter
...
%
\appto\bibfont{\setlength{\emergencystretch}{.3em}} % Antonio: resolve overfull boxes in the bibliography
\makebackmatter
